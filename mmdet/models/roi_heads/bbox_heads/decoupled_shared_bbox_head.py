...
class DecoupledSharedBBoxHead(BBoxHead):
    """
    Unshared2FC
    ...
    def __init__(self, 
                ...
                *args,
                **kwargs):
        super(DecoupledSharedBBoxHead, self).__init__(*args, **kwargs)
        self.num_shared_fcs = num_shared_fcs
        self.fc_out_channels = fc_out_channels

        self.shared_fcs = self._add_fc_branch(self.num_shared_fcs)
    ...
    def forward(self, x):
        ...
        for shared_fc in self.shared_fcs:
            x = self.relu(shared_fc(x))
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                losses['loss_bbox'] = self.loss_bbox(
                    ...
                    avg_factor=0.5*labels_reg.size(0),
                    reduction_override=reduction_override)
            else:
